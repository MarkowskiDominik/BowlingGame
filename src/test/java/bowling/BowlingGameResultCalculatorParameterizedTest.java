...
public class BowlingGameResultCalculatorParameterizedTest {
    ...
    private final Integer numberOfZeroRolls;
    private final List<Integer> listOfRolls;
    ...
    public static Collection testedRolls() {
        return Arrays.asList(new Object[][]{ { Type.NO_EXCEPTION, 0, Arrays
                .asList(), 0 }, { Type.NO_EXCEPTION, 0, Arrays.asList(0), 0 }, { Type.NO_EXCEPTION, 0, Arrays.asList(
                        9), 9 }, { Type.NO_EXCEPTION, 0, Arrays.asList(1, 1), 2 }, { Type.NO_EXCEPTION, 0, Arrays
                                .asList(9, 1, 9), 28 }, { Type.NO_EXCEPTION, 0, Arrays.asList(10, 8,
                                        1), 28 }, { Type.NO_EXCEPTION, 0, Arrays.asList(10, 10,
                                                5), 45 }, { Type.NO_EXCEPTION, 0, Arrays.asList(10, 10,
                                                        10), 60 }, { Type.NO_EXCEPTION, 18, Arrays.asList(10, 5,
                                                                4), 19 }, { Type.NO_EXCEPTION, 18, Arrays.asList(9, 1,
                                                                        2), 12 }, { Type.NO_EXCEPTION, 18, Arrays
                                                                                .asList(7,
                                                                                        2), 9 }, { Type.NO_EXCEPTION, 16, Arrays
                                                                                                .asList(10, 5,
                                                                                                        4), 28 }, { Type.NO_EXCEPTION, 16, Arrays
                                                                                                                .asList(9,
                                                                                                                        1,
                                                                                                                        5,
                                                                                                                        1), 21 }, { Type.NO_EXCEPTION, 16, Arrays
                                                                                                                                .asList(7,
                                                                                                                                        2,
                                                                                                                                        5,
                                                                                                                                        4), 18 }, { Type.EXCEPTION, 0, Arrays
                                                                                                                                                .asList(), 0 }, { Type.EXCEPTION, 0, Arrays
                                                                                                                                                        .asList(-1), 0 }, { Type.EXCEPTION, 0, Arrays
                                                                                                                                                                .asList(11), 0 }, { Type.EXCEPTION, 0, Arrays
                                                                                                                                                                        .asList(6,
                                                                                                                                                                                6), 0 }, { Type.EXCEPTION, 20, Arrays
                                                                                                                                                                                        .asList(0), 0 }
        });
    }
